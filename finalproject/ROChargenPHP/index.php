...
/**
* @fileoverview index.html, Dispatcher
...
Controller::$database =     "lovelyvh_cp_db"           ;   // Database Name
Controller::$username =     "user_sql5"           ;   // Database Username
Controller::$password =     "password1"           ;   // Database Pass
/// -----------------------------------------------------------------
